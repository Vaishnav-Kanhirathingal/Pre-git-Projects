...
class OrderFunctionalityTests : BaseTest() {
    ...
    fun `radio_buttons_update_entree_menu_subtotal`() {
        ...
        onView(withId(R.id.subtotal))
            .check(matches(withText(containsString("Subtotal"))))
    ...
    fun `subtotal_updates_in_full_order_flow`() {
        ...
        onView(withId(R.id.subtotal))
            .check(matches(withText(containsString("9.50"))))
    ...
    fun `subtotal_tax_total_in_checkout`() {
        ...
        onView(withId(R.id.tax))
            .check(matches(withText(containsString("Tax"))))
        onView(withId(R.id.tax))
            .check(matches(withText(containsString("0.80"))))
    ...
    fun `order_reset_after_cancel_from_entree_menu`() {
        ...
        onView(withText(containsString("Subtotal"))).check(matches(isDisplayed()))//todo - check?
        onView(withText(containsString("0.00"))).check(matches(isDisplayed()))//todo - check?
    }
    ...
    fun `order_reset_after_cancel_from_side_menu`() {
        ...
        onView(withId(R.id.start_order_btn)).perform(click())
        // Make sure subtotal is zero
        onView(withText(containsString("Subtotal"))).check(matches(isDisplayed()))
        onView(withText(containsString("0.00"))).check(matches(isDisplayed()))
    }
