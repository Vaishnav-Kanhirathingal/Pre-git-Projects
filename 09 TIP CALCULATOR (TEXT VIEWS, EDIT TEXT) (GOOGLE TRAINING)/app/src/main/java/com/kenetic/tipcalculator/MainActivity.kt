...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.roundUpTipTextView.text = getString(R.string.tip_amount,NumberFormat.getCurrencyInstance().format(0.0))
    }
    private fun calcTip(){
        ...
        binding.roundUpTipTextView.text = getString(R.string.tip_amount,NumberFormat.getCurrencyInstance().format(cost))
    }
}